"""
Django settings for oj_server project.
...
MIDDLEWARE = [
    ...
    'system.middleware.AdminEnabledMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'oj_server.urls'
...
WSGI_APPLICATION = 'oj_server.wsgi.application'
...
# JWT 配置：AUTH_HEADER_TYPES 设为 Token，与前端 judgeService.js 的 `Authorization: Token <jwt>` 对齐
SIMPLE_JWT = {
